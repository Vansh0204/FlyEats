    ...
    <div className="min-h-screen bg-gray-50 pb-24">
      <header className="bg-white shadow-sm sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <Link href={`/airports/${airportId}/outlets${gateNumber ? `?gate=${gateNumber}` : ''}`} className="text-gray-600 hover:text-orange-600">
              ...
              {cart.length === 0 ? (
                ...
                <>
                  ...
                  <div className="border-t pt-4 mb-6">
                    ...
                    <Link
                      href={`/checkout?outletId=${outlet.id}&airportId=${airportId}${gateNumber ? `&gate=${gateNumber}` : ''}`}
                      onClick={() => {
